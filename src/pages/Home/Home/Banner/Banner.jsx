              ...
              <div className=" max-w-7xl mx-auto flex items-center h-full">
                <div>
                  <div>
                    ...
                    <Link
                      to="/needVolunteer"
                      className="btn btn-outline btn-sm lg:btn-md text-gray-200 text-xs md:text-sm lg:text-base border-[#955E42] hover:bg-[#955E42] hover:border-[#955E42] md:px-6"
                    >
                      Need Volunteer
                    </Link>
                  </div>
              ...
              <div className=" max-w-7xl mx-auto flex items-center h-full">
                <div>
                  <div>
                    ...
                    <Link
                      to="/needVolunteer"
                      className="btn btn-outline btn-sm lg:btn-md text-gray-200 text-xs md:text-sm lg:text-base border-[#955E42] hover:bg-[#955E42] hover:border-[#955E42] hover:text-black  md:px-6"
                    >
                      Need Volunteer
                    </Link>
                  </div>
